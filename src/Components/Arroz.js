        ...
        <div >
          <Accordion style={{backgroundColor:"",color:""}}>
            ...
            >
              ...
              <Typography>Pre-Construction Services</Typography>
              </div>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
          ...
          <Accordion>
            <AccordionSummary
              ...
              id="panel2a-header"
            >
              <Typography>Virtual Assistants</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
          ...
          <Accordion>
            <AccordionSummary
              ...
              id="panel2a-header"
            >
              <Typography>Construction Accounting</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
